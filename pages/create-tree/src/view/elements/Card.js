...
export function Card(props) {
  ...
  return function ({node, d}) {
    const el = document.createElementNS("http://www.w3.org/2000/svg", 'g'),
      ...
      card_body = () => !d.data.to_add ? CardBody({d,card_dim, card_display: props.card_display}).template : CardBodyAddNew({d,card_dim, card_add: props.cardEditForm, label: 'DODAJ PARTNERA'}).template,
